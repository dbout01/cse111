def main():
    # Read the contents of a text file named provinces.txt into a list named provinces_list
    ...
    # Call the list.count method which will count the number of times that Alberta appears in the list
