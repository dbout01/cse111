...
def main():
    ...
    # Display the computed molar mass
    print(f"{molar_mass} grams/mole")

    # Convert the mass to moles
    moles = mass / float(molar_mass)
...
def make_periodic_table():
    """
    Parameters: none
    Return: compound list of elements
    """
    periodic_table_list = {
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    Parameters:
        symbol_quantity_list (list):
            A compound list returned from the parse_formula function
    ...
    for element in symbol_quantity_list:
        symbol = element[0]  # Access symbol at index 0
        quantity = element[1]  # Access quantity at index 1
        atomic_mass = periodic_table_dict[symbol][1]  # Access atomic mass at index 1
